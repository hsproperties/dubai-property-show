        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-2xl lg:text-3xl text-gray-200 mb-12 max-w-4xl mx-auto leading-relaxed">
              Experience Dubai's most comprehensive property showcase where
              every option is compared, every question is answered, and every
              decision is made with complete confidence.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="text-gray-900">
              <h3 className="text-2xl font-bold mb-6">Visit DPS</h3>
